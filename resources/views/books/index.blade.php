            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('books.my-books') }}" class="text-blue-600 hover:text-blue-800">View All My
                            Books</a>
                    </div>
                            ...
                            @foreach ($userBooks->take(3) as $book)
                                <div
                                    ...
                                    <div class="p-4">
                                        ...
                                        @endif
                                        <p class="text-gray-600 text-sm mb-2">Uploaded by you
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('books.my-books') }}" class="text-blue-600 hover:text-blue-800">View All
                            Enrolled Books</a>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('books.library') }}" class="text-blue-600 hover:text-blue-800">View All
                            Public Books</a>
                    </div>
