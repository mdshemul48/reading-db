            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('books.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <!-- PDF File -->
                        <div class="mt-4">
                            <x-input-label for="pdf_file" :value="__('PDF File (max 200MB)')" />
                            <input id="pdf_file" type="file" name="pdf_file" class="mt-1 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" accept=".pdf" required />
                            <x-input-error :messages="$errors->get('pdf_file')" class="mt-2" />
                        </div>

                        <!-- Thumbnail -->
                        <div class="mt-4">
                            <x-input-label for="thumbnail" :value="__('Thumbnail Image (optional, max 20MB)')" />
                            ...
                            <p class="mt-1 text-sm text-gray-500">Supported formats: JPEG, PNG, JPG, GIF</p>
