                        ...
                        <div class="mt-4">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="is_private" name="is_private" type="checkbox" class="w-4 h-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" {{ old('is_private', $book->is_private) ? 'checked' : '' }}>
                                </div>
